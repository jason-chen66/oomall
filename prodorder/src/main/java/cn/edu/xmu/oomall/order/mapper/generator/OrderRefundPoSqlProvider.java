...
import cn.edu.xmu.oomall.order.mapper.generator.po.OrderRefundPoExample.Criteria;
import cn.edu.xmu.oomall.order.mapper.generator.po.OrderRefundPoExample.Criterion;
import cn.edu.xmu.oomall.order.mapper.generator.po.OrderRefundPoExample;
import java.util.List;
import java.util.Map;
import org.apache.ibatis.jdbc.SQL;

public class OrderRefundPoSqlProvider {
    /**
     ...
     * @mbg.generated
     */
    public String insertSelective(OrderRefundPo row) {
        SQL sql = new SQL();
        sql.INSERT_INTO("order_refund");
        ...
        if (row.getRefundId() != null) {
            sql.VALUES("`refund_id`", "#{refundId,jdbcType=BIGINT}");
        }
     ...
     * @mbg.generated
     */
    public String selectByExample(OrderRefundPoExample example) {
        SQL sql = new SQL();
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        OrderRefundPo row = (OrderRefundPo) parameter.get("row");
        OrderRefundPoExample example = (OrderRefundPoExample) parameter.get("example");
        
        SQL sql = new SQL();
        sql.UPDATE("order_refund");
        ...
        if (row.getRefundId() != null) {
            sql.SET("`refund_id` = #{row.refundId,jdbcType=BIGINT}");
        }
        
        if (row.getPoint() != null) {
            sql.SET("`point` = #{row.point,jdbcType=INTEGER}");
        }
     ...
     * @mbg.generated
     */
    public String updateByPrimaryKeySelective(OrderRefundPo row) {
        SQL sql = new SQL();
        sql.UPDATE("order_refund");
        ...
        if (row.getRefundId() != null) {
            sql.SET("`refund_id` = #{refundId,jdbcType=BIGINT}");
        }
     ...
     * @mbg.generated
     */
    protected void applyWhere(SQL sql, OrderRefundPoExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
