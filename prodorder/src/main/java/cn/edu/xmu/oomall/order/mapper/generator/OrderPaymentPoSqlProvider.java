...
import cn.edu.xmu.oomall.order.mapper.generator.po.OrderPaymentPoExample.Criteria;
import cn.edu.xmu.oomall.order.mapper.generator.po.OrderPaymentPoExample.Criterion;
import cn.edu.xmu.oomall.order.mapper.generator.po.OrderPaymentPoExample;
import java.util.List;
import java.util.Map;
import org.apache.ibatis.jdbc.SQL;

public class OrderPaymentPoSqlProvider {
    /**
     ...
     * @mbg.generated
     */
    public String insertSelective(OrderPaymentPo row) {
        SQL sql = new SQL();
        sql.INSERT_INTO("order_payment");
        ...
        if (row.getPaymentId() != null) {
            sql.VALUES("`payment_id`", "#{paymentId,jdbcType=BIGINT}");
        }
     ...
     * @mbg.generated
     */
    public String selectByExample(OrderPaymentPoExample example) {
        SQL sql = new SQL();
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        OrderPaymentPo row = (OrderPaymentPo) parameter.get("row");
        OrderPaymentPoExample example = (OrderPaymentPoExample) parameter.get("example");
        
        SQL sql = new SQL();
        sql.UPDATE("order_payment");
        ...
        if (row.getPaymentId() != null) {
            sql.SET("`payment_id` = #{row.paymentId,jdbcType=BIGINT}");
        }
     ...
     * @mbg.generated
     */
    public String updateByPrimaryKeySelective(OrderPaymentPo row) {
        SQL sql = new SQL();
        sql.UPDATE("order_payment");
        ...
        if (row.getPaymentId() != null) {
            sql.SET("`payment_id` = #{paymentId,jdbcType=BIGINT}");
        }
     ...
     * @mbg.generated
     */
    protected void applyWhere(SQL sql, OrderPaymentPoExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
