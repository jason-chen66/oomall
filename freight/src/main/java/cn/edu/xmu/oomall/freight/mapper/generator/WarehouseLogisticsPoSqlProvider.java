...
import cn.edu.xmu.oomall.freight.mapper.generator.po.WarehouseLogisticsPoExample.Criteria;
import cn.edu.xmu.oomall.freight.mapper.generator.po.WarehouseLogisticsPoExample.Criterion;
import cn.edu.xmu.oomall.freight.mapper.generator.po.WarehouseLogisticsPoExample;
import java.util.List;
import java.util.Map;
import org.apache.ibatis.jdbc.SQL;

public class WarehouseLogisticsPoSqlProvider {
    /**
     ...
     * @mbg.generated
     */
    public String insertSelective(WarehouseLogisticsPo row) {
        SQL sql = new SQL();
        sql.INSERT_INTO("freight_warehouse_logistics");
        
        if (row.getWarehouseId() != null) {
            sql.VALUES("`warehouse_id`", "#{warehouseId,jdbcType=BIGINT}");
        }
     ...
     * @mbg.generated
     */
    public String selectByExample(WarehouseLogisticsPoExample example) {
        SQL sql = new SQL();
        ...
        sql.SELECT("`end_time`");
        sql.SELECT("`invalid`");
        sql.FROM("freight_warehouse_logistics");
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        WarehouseLogisticsPo row = (WarehouseLogisticsPo) parameter.get("row");
        WarehouseLogisticsPoExample example = (WarehouseLogisticsPoExample) parameter.get("example");
        
        SQL sql = new SQL();
        sql.UPDATE("freight_warehouse_logistics");
        ...
        if (row.getWarehouseId() != null) {
            sql.SET("`warehouse_id` = #{row.warehouseId,jdbcType=BIGINT}");
        }
     ...
     * @mbg.generated
     */
    public String updateByPrimaryKeySelective(WarehouseLogisticsPo row) {
        SQL sql = new SQL();
        sql.UPDATE("freight_warehouse_logistics");
     ...
     * @mbg.generated
     */
    protected void applyWhere(SQL sql, WarehouseLogisticsPoExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
